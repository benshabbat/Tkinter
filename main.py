...
code_hc_label.grid(row=1,column=1 ,padx=5,pady=5)
code_hc_combobox = ttk.Combobox(data_info,values=["אדום","צהוב"])
code_hc_combobox.grid(row=1,column=0,padx=5,pady=5)


mana_label= tkinter.Label(data_info,text="מנת")
mana_label.grid(row=2,column=1,padx=5,pady=5)
mana_entry = tkinter.Entry(data_info)
mana_entry.grid(row=2 ,column=0,padx=5,pady=5)


number_mana_label= tkinter.Label(data_info,text="מספר מנה")
number_mana_label.grid(row=3,column=1,padx=5,pady=5)
number_mana_entry = tkinter.Entry(data_info)
number_mana_entry.grid(row=3 ,column=0,padx=5,pady=5)
